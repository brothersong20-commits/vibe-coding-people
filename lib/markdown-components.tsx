...
// react-markdown 의 components prop 매핑.
// DESIGN.md 톤(웜 크림 + 헤어라인 + display weight 400)을 유지하기 위해
// mdx-components.tsx 의 매핑을 그대로 이식했다.
export const markdownComponents: Components = {
  ...
  h3: ({ children }) => <h3 className="display-sm mt-8 mb-3">{children}</h3>,
  p: ({ children }) => (
